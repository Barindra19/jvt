...
class UserController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->_data['MenuActive']                      = 'User Management';
    ...
    public function index(){
        $this->_data['MenuDescription']                 = 'Daftar User';
        $this->_data['datatables']                      = 'user_management';
    ...
    public function datatables(){
        $User = UserModel::join('role_user',"users.id","=","role_user.user_id")
                        ...
                        ->select(['users.id', 'users.name as name','users.email as email','roles.name as roles','users.is_active'])
                        ->where('users.id','>',1);
    ...
    public function add(){
        ...
        $this->_data['MenuDescription']             = 'Tambah User Baru';
    ...
    public function edit(Request $request){
        ...
        $this->_data['MenuDescription']             = 'Edit User';
...
//
//            $EmailParams                            = array(
//                'Subject'                               => "Selamat datang di Java Tour",
