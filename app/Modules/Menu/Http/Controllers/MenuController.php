...
class MenuController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->_data['MenuActive']                  = 'Menu';
        $this->_data['form_name']                   = 'menu';
    }

    public function index(){
        $this->_data['MenuDescription']             = 'Daftar Menu';
    ...
    public function datatables(){
        $Menu = MenuModel::select(['id', 'name', 'url', 'permission', 'icon', 'order', 'created_at', 'updated_at']);
    ...
    public function edit(Request $request){
        ...
        $this->_data['MenuDescription']             = 'Edit Menu';
