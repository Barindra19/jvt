...
class PermissionController extends Controller
{
    ...
    {
        $this->_data['MenuActive']                  = 'Permission';
        $this->_data['form_name']                   = 'permission';
    }

    public function index(){
        $this->_data['MenuDescription']             = 'Daftar Permission';
    ...
    public function add(){
        $this->_data['state']                       = 'add';
            $this->_data['MenuDescription']             = 'Form Tambah Permission baru';
    ...
    public function edit(Request $request){
        ...
        $this->_data['MenuDescription']             = 'Form Perubahan Permission';
        $this->_data['datatables']                  = 'permission';
