...
class ThirdMenuController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->_data['MenuActive']                  = 'Thirdmenu';
        $this->_data['form_name']                   = 'thirdmenu';
    }

    public function index(){
        $this->_data['MenuDescription']             = 'Daftar Thirdmenu';
    ...
    public function add(){
        ...
        $this->_data['MenuDescription']         = 'Tambah Thirdmenu Baru';
    ...
    public function edit(Request $request){
        ...
        $this->_data['MenuDescription']         = 'Edit Thirdmenu';
